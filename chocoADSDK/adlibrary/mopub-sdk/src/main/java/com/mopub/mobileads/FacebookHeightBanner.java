...
public class FacebookHeightBanner extends CustomEventBanner implements AdListener {
    ...
    protected void loadBanner(final Context context,
        ...
        mFacebookBanner = new AdView(context, placementId, AdSize.RECTANGLE_HEIGHT_250);
